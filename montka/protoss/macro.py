...
class Macro:
    ...
    def _gas(self) -> None:
        ...
        # Main always qualifies. Natural and onwards qualify only once the next
        # base's Nexus has been committed (ready or pending).
        home = self.ai.start_location
        nexus_type = self.ai.base_townhall_type
    ...
    def _mining(self) -> None:
        # Mining() handles all worker assignments: idle workers to minerals/gas,
        # rebalancing after builds, and efficient patch spreading.
